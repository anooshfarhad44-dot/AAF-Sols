      ...
      <div className="max-w-screen-xl px-6 py-12 mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-full font-bold transition-all transform hover:scale-105">
              Get Started
            </button>
            <button className="px-8 py-4 border border-gray-700 hover:bg-gray-800 rounded-full font-bold transition-all">
              Our Portfolio
            </button>
          </div>
        </motion.div>
        ...
        >
          <div className="relative w-full h-[400px] md:h-[550px] rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden shadow-2xl">
             ...
             />
             {/* Overlay Gradient to make it look modern */}
